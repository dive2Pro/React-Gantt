...
const AwaitView = valueStaticProps(class AwaitView extends React.PureComponent {
  constructor(props) {
    super(props)
    this.unregisters = []
  }
  componentWillUnmount() {
    if (this.unregisters.length) {
  ...
  render() {
    ...
    this.unregisters.push(styleUpdateMap.add(leftLineId, calcCss))
